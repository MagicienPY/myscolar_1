...
#frame interne
    ...
    #fin frame pricipale
        ...
        ###############################
            ...
            button2 = ctk.CTkButton(master=gauche_frame, text="Afficher bulletin",command=afficher_bulletin)
            button2.pack(side="top", fill= "x", expand = False) 
    ##################################################################
          
    #####################################################################
            button13 = ctk.CTkButton(master=gauche_frame, text="imprimer",command=afficher_bulletin)
            button13.pack(side="top", fill= "x", expand = False)
            ...
            tableresultat = ttk.Treeview(droit_frame,columns=(1,2,3,4,5,6,7,8,9), height=20, show= "headings")
            tableresultat.pack(fill="both",pady=10,padx=10)
            tableresultat.heading(1,text = "semestre")
            tableresultat.heading(2,text = "matière")
            tableresultat.heading(3,text = "note du  cc")
            tableresultat.heading(4,text = "note de la sn")
            tableresultat.heading(5,text = "coef")
            tableresultat.heading(6,text = "sn + cc")
            tableresultat.heading(7,text = "matricule")
            tableresultat.heading(8,text = "nom etudiant")
            tableresultat.heading(9,text = "type de note")
            ...
            for ligne in cursor:
                tableresultat.insert('',END, value= ligne)
